      ...
      <div className="IntroSection">
        <div className="introSection-left">
          <Fade bottom delay={50}>
            <h1>
              Speak , Write , <span>Succeed</span>
            </h1>
          </Fade>
          <Fade bottom delay={100}>
            <p>
              Lektore provides assimilation pathways for safe migration to
              English Speaking countries by using language, professional &
              social tools for migrating professionals, students, Business
              people and refugees. It also provides elocution & language to
        ...
        <div className="introSection-right"></div>
      </div>
    </div>
  );
};
