    ...
    return(
        ...
        <div className='Navbar'>
            <div className="nav-left">
                <img src="./assets/Frame.jpg" alt="" /> <NavLink to='/'>LEKTOR</NavLink>
            </div>
            <div className="nav-right">
                <div className="tabs">
                    <div className="dropdown" id='dropdown1'>
                        <NavLink to= '#' onClick={()=>firstDrop()}>Our Services</NavLink>
                        { firstDropdown && <ul className='swing-in-top-fwd' ref={first}>
                            <li>IELTS</li>
                    ...
                    <div className="dropdown" id='dropdown2'>
                        <NavLink to='#' onClick={()=>secondDrop()}>Who we Service</NavLink>
                        {secondDropdown && <ul className="swing-in-top-fwd">
                            <li>An immigrant</li>
                    ...
                    <div className="dropdown" id='dropdown3'>
                        <NavLink to='#' onClick={()=>thirdDrop()}>pathways</NavLink>
                        {thirdDropdown && <ul className="swing-in-top-fwd">
                            <li>I am</li>
                        </ul>
                        }
                    </div>
                    <NavLink to='/'>Socials & Events</NavLink>
                    <NavLink to='/'>Contact</NavLink>
                </div>

                <div className="signUser">
                    <NavLink to='/login'>Tutor Login</NavLink>
